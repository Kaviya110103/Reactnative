...
const EmployeeCalendar = ({ employeeId }: { employeeId: number }) => {
  ...
  const fetchAttendanceData = (month: number, year: number) => {
    ...
    axios
      .get(
        `http://192.168.1.8:8080/api/attendance/employee/${employeeId}?month=${
          month + 1
        }&year=${year}`
      )
      .then((response) => {
            ...
            {selectedAttendance ? (
              <>
                ...
                <View style={styles.imagesContainer}>
                  <Image
                    source={{
                      uri: `http://192.168.1.8:8080/api/images/displayImage1ByAttendanceId/${selectedAttendance.id}`,
                    }}
                  ...
                  <Image
                    source={{
                      uri: `http://192.168.1.8:8080/api/images/displayImage2ByAttendanceId/${selectedAttendance.id}`,
                    }}
                    style={styles.attendanceImage}
                    resizeMode="cover"
                  />
